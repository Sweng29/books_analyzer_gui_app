 ...
 * @author Kashif Ali
 */
public class DeleteMessageForm extends javax.swing.JFrame {
    ...
    public DeleteMessageForm(String header,String message,String icon) {
        initComponents();
        jLabel2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jLabel2KeyReleased(evt);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        int a = new BookDetailDAOImpl().deleteAll();
        check = a;
        if(a==1)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteMessageForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteMessageForm().setVisible(true);
            }
        });
    }
